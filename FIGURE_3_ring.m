%% This code generates FIGURE 3 ring.
...
imin = round(10/dt);        % time before starting the RLS
...
eta = eta*J;                 % part of the weight matrix
...
%% eigenvalues
figure(40)
Z = eig(OMEGA + eta*BPhi');     % eigenvalues after learning 
