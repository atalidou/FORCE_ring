%% This code generates FIGURE 6 FitzHugh-Nagumo.

clear;
close all;

Q1_plus = -0.5;     % ring component (fwd)
Q1_minus = -0.5;    % ring component (bwd)
...
step = 30;                  % optimize with RLS every "step" steps
